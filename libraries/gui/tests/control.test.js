...
describe("Control", () => {
    ...
    beforeEach(() => {
        ...
        let ctl = new Control([key], "change something",
            variable)
    ...
    it("is a tr with a first column with the key", () => {
        ...
        chai.expect(formatted.querySelector(".t1"))
            .to.have.text("T")
    })
    ...
    it("is a tr with a second column with the description", () => {
        ...
        chai.expect(formatted.querySelector(".t2"))
    ...
    it("is a tr with a third column with the variable", () => {
        ...
        chai.expect(formatted.querySelector(".t3"))
            .to.have.text("[42]")
    })
})