...
const sketch = (s) => {
  ...
  const createGUI = (gui) => {
    ...
    cfg.subinfo = "Based on the ideas about point distribution from <a href='https://openprocessing.org/sketch/1575230/'>here</a><br/>Not much more than stacked blur on top and some masking.<br/>Only reproducible at the exact same resolution."
    cfg.s = s
    R = new Key("r", () => {
      gui.spin(() => {
        cfg.s.clear()
