...
import { Seeder } from "../libraries/gui/seeder.js";

import { getLargeCanvas, darken, gaussColor } from "../libraries/misc.js";

import { wernerBasePalette, solarizedDark } from "../libraries/palettes.js";
...
const sketch = (s) => {
  ...
  function createGUI() {
    let info = "Investigation of composition and masking";
    ...
    let gui = new GUI(
      "Underwater, RB 2023/05 \u{1F1E8}\u{1F1ED}",
      info,
      subinfo,
