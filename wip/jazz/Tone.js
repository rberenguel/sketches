!(function (t, e) {
  ...
  return (function (t) {
        ...
        r = (t, e, n, r, a, c, u, h) => {
          ...
          return class d {
            constructor(d) {
              ...
              const m =
                null !== r && e(c, c)
                  ? new r({ length: p, numberOfChannels: f, sampleRate: _ })
                    ...
                    : "interactive" === o || void 0 === o
                      ...
                      : "playback" === o
                        ...
                        : (128 *
                            Math.max(
                              2,
                              Math.min(128, Math.round((o * r) / 128)),
                            )) /
                          r),
                ...
                const u = e(a, {
                  ...
                  d = (e, i) => {
                    ...
                    return (
                      ...
                      t({ context: r }, h, o.offset, s.b, s.a)
                    );
                  };
                let p = [0, 0, -1, 0, 1, 0],
                  f = [0, 0, 0];
        ...
        class extends f {
          constructor(e, n) {
            super(e, n),
              ...
              (this._audioWorklet =
                void 0 === t ? void 0 : { addModule: (e, n) => t(this, e, n) });
          }
          get audioWorklet() {
      ...
      const s = {
        ...
        i = (t, e, n, i, o) =>
          class extends t {
            constructor(t, r = s) {
              const a = i(t),
                c = ((t) => ({ ...t, channelCount: t.numberOfOutputs }))({
                  ...s,
                  ...r,
                });
              super(t, !1, n(a, c), o(a) ? e() : null);
                    ...
                    : "interactive" === r || void 0 === r
                      ...
                      : "playback" === r
                        ...
                        : (128 *
                            Math.max(
                              2,
                              Math.min(128, Math.round((r * a) / 128)),
                            )) /
                          a),
      ...
      const i = (t, e, n, i, o, r) =>
        class extends n {
          constructor(n, r) {
            ...
            Object.defineProperty(n, "sampleRate", { get: () => a }),
              i(n) && o.set(n, new Set()),
    ...
    function (t, e, n) {
      ...
      const s = (t, e) => (n, s, i) => {
        ...
        i &&
          ...
          0 === o.maxChannelCount &&
            Object.defineProperty(o, "maxChannelCount", { value: s });
        const r = t(n, {
          channelCount: s,
    ...
    function (t, e, n) {
      ...
      const i = (t, e) => (n, i) => {
        ...
        return (
          Object(s.a)(o, i),
          1 === o.numberOfOutputs &&
            Object.defineProperty(o, "numberOfOutputs", { get: () => 0 }),
          o
        );
      };
    },
    ...
    function (t, e, n) {
      ...
      const s =
        ...
        (e, { disableNormalization: n, imag: s, real: i }) => {
          ...
          return null !== o
            ? o.createPeriodicWave(a, r, { disableNormalization: n })
            : e.createPeriodicWave(a, r, { disableNormalization: n });
        };
    },
    function (t, e, n) {
      "use strict";
          ...
          class extends t {
            constructor(t, n, r) {
              ...
              if ("number" == typeof t && void 0 !== n && void 0 !== r)
                a = { length: n, numberOfChannels: t, sampleRate: r };
              else {
                if ("object" != typeof t)
            ...
            return void 0 !== g
              ...
              : (async (f, _, m) => {
                  ...
                  const y = {
                    ...
                    x = Object(i.a)(v, _);
                  if ("bufferSize" in v) g = o(_, { ...y, gain: 1 });
                  else if (!x) {
                    const t = {
                      ...b,
    ...
    function (t, e, n) {
      ...
      const s = { disableNormalization: !1 },
        i = (t, e, n) =>
          class i {
            constructor(i, o) {
              const r = e(i),
                ...
                ((t) => {
                  ...
                  (t.connect =
                    ...
                    (t, s = 0, i = 0) => {
                      ...
                      return (
                        void 0 === r
                          ? e.set(t, [{ input: i, output: s }])
                          : r.every((t) => t.input !== i || t.output !== s) &&
                            r.push({ input: i, output: s }),
                        o
                      );
                    })),
                    (t.disconnect =
          ...
          if (null !== Y)
            for (let s = 0; s < R; s += 128) {
              ...
              try {
                ...
                (H = !1),
                  z.dispatchEvent(
                    new ErrorEvent("processorerror", { error: t }),
                  );
              }
              if (!H) {
                for (let t = 0; t < O.numberOfInputs; t += 1) {
        ...
        if (g(t) && g(n))
          for (const e in n)
            E(e, n[e])
              ? (t[e] = n[e])
              : g(n[e])
                ? (t[e] || Object.assign(t, { [e]: {} }), R(t[e], n[e]))
      ...
      function q(t, e, n = [], s) {
        ...
        if (g(o[0]) && s && !Reflect.has(o[0], s)) {
          Object.keys(o[0]).some((e) => Reflect.has(t, e)) ||
            (R(i, { [s]: o[0] }), n.splice(n.indexOf(s), 1), o.shift());
        }
...
***************************************************************************** */ this
      ...
      class Ot extends W {
        ...
        setStateAtTime(t, e, n) {
          return (
            a(e, 0), this.add(Object.assign({}, n, { state: t, time: e })), this
          );
        }
        getLastState(t, e) {
      ...
      class St extends Tt {
        ...
        setValueAtTime(t, e) {
          ...
          return (
            r(
              ...
              `Invalid argument(s) to setValueAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`,
            ),
            this._assertRange(s),
        ...
        linearRampToValueAtTime(t, e) {
          ...
          return (
            r(
              ...
              `Invalid argument(s) to linearRampToValueAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`,
            ),
            this._assertRange(n),
            this._events.add({
              time: s,
        ...
        exponentialRampToValueAtTime(t, e) {
          ...
          return (
            r(
              isFinite(n) && isFinite(s),
              `Invalid argument(s) to exponentialRampToValueAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`,
            ),
            this._events.add({
              time: s,
        ...
        setTargetAtTime(t, e, n) {
          ...
          return (
            ...
            r(
              ...
              `Invalid argument(s) to setTargetAtTime: ${JSON.stringify(t)}, ${JSON.stringify(e)}`,
            ),
            this._events.add({
              constant: n,
              time: i,
      ...
      class jt extends Ct {
        constructor(t) {
          super(t),
            ...
            (this._stopTime = -1),
            (this._timeout = -1),
            (this.output = new Mt({ context: this.context, gain: 0 })),
      ...
      class Pt extends V {
        constructor(t) {
          super(),
            ...
            (this._timeline = new W({ memory: 10 })),
      ...
      class Xt extends Ct {
        constructor() {
          super(q(Xt.getDefaults(), arguments)),
            ...
            (this.input = new Zt({ context: this.context })),
            (this.output = new Mt({ context: this.context })),
      ...
      const oe = { brown: null, pink: null, white: null },
        re = {
          get brown() {
            if (!oe.brown) {
              const t = [];
      ...
      class ae extends Ct {
        constructor() {
          ...
          (this._volume = this.output =
            new Zt({ context: this.context, volume: t.volume })),
            (this.volume = this._volume.volume),
            $(this, "volume"),
            (this.mute = t.mute);
        }
      ...
      class de extends le {
        constructor() {
          super(
            Object.assign(
              q(de.getDefaults(), arguments, ["mapping", "length"]),
            ),
          ),
      ...
      class _e extends ne {
        constructor() {
          super(
            ...
            (this._modulationScale = new pe({ context: this.context })),
            (this._modulationNode = new Mt({ context: this.context }));
      ...
      class me extends ne {
        constructor() {
          super(
            ...
            (this._modulationNode = new Mt({ context: this.context, gain: 0 }));
      ...
      class ge extends ne {
        constructor() {
          super(q(ge.getDefaults(), arguments, ["frequency", "width"])),
            ...
            (this._widthGate = new Mt({ context: this.context, gain: 0 })),
            (this._thresh = new de({
              context: this.context,
              mapping: (t) => (t <= 0 ? -1 : 1),
            }));
      ...
      class we extends Rt {
        constructor() {
          super(Object.assign(q(we.getDefaults(), arguments, ["value"]))),
            (this.override = !1),
            (this.name = "Add"),
            (this._sum = new Mt({ context: this.context })),
      ...
      class Te extends le {
        constructor() {
          ...
          (this._mult = this.input =
            new fe({ context: this.context, value: t.max - t.min })),
            (this._add = this.output =
              new we({ context: this.context, value: t.min })),
            (this._min = t.min),
            (this._max = t.max),
      ...
      class Oe extends le {
        constructor() {
          super(Object.assign(q(Oe.getDefaults(), arguments))),
            (this.name = "Zero"),
            (this._gain = new Mt({ context: this.context })),
      ...
      class Se extends Ct {
        constructor() {
          ...
          (this._oscillator = new he({
            ...
            (this._zeros = new Oe({ context: this.context })),
            (this._a2g = new pe({ context: this.context })),
            (this._scaler = this.output =
              new Te({ context: this.context, max: t.max, min: t.min })),
            (this.units = t.units),
            (this.min = t.min),
            (this.max = t.max),
      ...
      class Re extends le {
        constructor() {
          super(...arguments),
            (this.name = "Negate"),
            (this._multiply = new fe({ context: this.context, value: -1 })),
      ...
      class qe extends Rt {
        constructor() {
          super(Object.assign(q(qe.getDefaults(), arguments, ["value"]))),
            ...
            (this.input = this._sum),
            (this.output = this._sum),
            (this._neg = new Re({ context: this.context })),
        ...
        constructor() {
          super(Object.assign(q(Ie.getDefaults(), arguments))),
            ...
            (this._scale = this.input =
              new fe({ context: this.context, value: 1e4 })),
      ...
      class Fe extends Rt {
        constructor() {
          ...
          (this._subtract = this.input =
            new qe({ context: this.context, value: t.value })),
            (this._gtz = this.output = new Ie({ context: this.context })),
      ...
      class Ne extends Te {
        constructor() {
          ...
          (this.input = this._exp =
            new Ve({ context: this.context, value: t.exponent })),
      ...
      class Ue extends Le {
        constructor() {
          super(
            ...
            (this._gainNode = new Mt({ context: this.context, gain: 0 })),
            (this.output = this._gainNode),
            (this.input = this._gainNode),
      ...
      class Xe extends Ct {
        constructor() {
          super(
            ...
            (this.name = "Filter"),
            (this.input = new Mt({ context: this.context })),
            (this.output = new Mt({ context: this.context })),
            (this._filters = []);
      ...
      class dn extends Be {
        constructor() {
          ...
          (this._noise = new ie({ context: this.context, type: "pink" })),
        ...
        _triggerAttack(t, e, n) {
          t.forEach((t) => {
            ...
            i &&
              ...
              this._activeVoices.push({ midi: s, voice: i, released: !1 }),
      ...
      class gn extends _n {
        ...
        start(t, e) {
          ...
          if ("started" !== this._state.getValueAtTime(n)) {
            ...
            this._state.add({ id: -1, offset: t, state: "started", time: n }),
              this._forEach((e) => {
      ...
      class Dn extends Ct {
        constructor() {
          super(Object.assign(q(Dn.getDefaults(), arguments, ["fade"]))),
            ...
            (this._g2a = new Ee({ context: this.context })),
            (this.a = new Mt({ context: this.context, gain: 0 })),
            (this.b = new Mt({ context: this.context, gain: 0 })),
            (this.output = new Mt({ context: this.context })),
        ...
        static getDefaults() {
          return Object.assign(Ct.getDefaults(), { fade: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Mn extends Ct {
        constructor(t) {
          super(t),
            (this.name = "Effect"),
            (this._dryWet = new Dn({ context: this.context })),
            (this.wet = this._dryWet.fade),
            (this.effectSend = new Mt({ context: this.context })),
            (this.effectReturn = new Mt({ context: this.context })),
            (this.input = new Mt({ context: this.context })),
      ...
      class In extends Ct {
        constructor() {
          ...
          (this._abs = this.input = new je({ context: this.context })),
        ...
        static getDefaults() {
          return Object.assign(Ct.getDefaults(), { smoothing: 0.05 });
        }
        get smoothing() {
      ...
      class Fn extends Mn {
        constructor() {
          ...
          (this._follower = new In({
            ...
            (this._baseFrequency = this.toFrequency(t.baseFrequency)),
            (this._octaves = t.octaves),
            (this._inputBoost = new Mt({ context: this.context })),
      ...
      class Pn extends Mn {
        constructor() {
          ...
          (this._shaper = new de({ context: this.context, length: 4096 })),
            (this._order = t.order),
        ...
        constructor(t) {
          super(t),
            ...
            (this._dryWet = this.output =
              new Dn({ context: this.context, fade: t.wet })),
            (this.wet = this._dryWet.fade),
            (this._split = new Ln({ context: this.context, channels: 2 })),
            (this._merge = new zn({ context: this.context, channels: 2 })),
      ...
      class Wn extends Bn {
        constructor(t) {
          super(t),
            ...
            (this._feedbackL = new Mt({ context: this.context })),
            (this._feedbackR = new Mt({ context: this.context })),
        ...
        static getDefaults() {
          return Object.assign(Bn.getDefaults(), { feedback: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Un extends Wn {
        constructor() {
          ...
          (this._depth = t.depth),
            ...
            (this._delayNodeL = new Qt({ context: this.context })),
            (this._delayNodeR = new Qt({ context: this.context })),
      ...
      class Yn extends Mn {
        ...
        static getDefaults() {
          return Object.assign(Mn.getDefaults(), { feedback: 0.125 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class Zn extends Ct {
        constructor(t) {
          super(t),
            ...
            (this.input = new Mt({ context: this.context })),
            (this.output = new Mt({ context: this.context })),
            (this.offset90 = new Mt({ context: this.context }));
      ...
      class Xn extends Mn {
        constructor() {
          ...
          (this.frequency = new Rt({
            ...
            (this._sine = new ue({ context: this.context, type: "sine" })),
            (this._cosine = new he({
              context: this.context,
              phase: -90,
              type: "sine",
            })),
            (this._sineMultiply = new fe({ context: this.context })),
            (this._cosineMultiply = new fe({ context: this.context })),
            (this._negate = new Re({ context: this.context })),
            (this._add = new we({ context: this.context })),
            (this._phaseShifter = new Zn({ context: this.context })),
      ...
      class ns extends Bn {
        ...
        static getDefaults() {
          return Object.assign(Bn.getDefaults(), { roomSize: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class os extends Yn {
        constructor() {
          ...
          (this._frequency = new Rt({ context: this.context })),
            (this._delayA = new Qt({ maxDelay: 1, context: this.context })),
            (this._lfoA = new Se({
              context: this.context,
              min: 0,
              max: 0.1,
            ...
            (this._delayB = new Qt({ maxDelay: 1, context: this.context })),
            (this._lfoB = new Se({
              context: this.context,
              min: 0,
              max: 0.1,
            ...
            (this._crossFade = new Dn({ context: this.context })),
        ...
        constructor() {
          super(q(cs.getDefaults(), arguments)),
            ...
            (this._split = this.input =
              new Ln({ channels: 2, context: this.context })),
            (this._midAdd = new we({ context: this.context })),
            (this.mid = new fe({ context: this.context, value: Math.SQRT1_2 })),
            (this._sideSubtract = new qe({ context: this.context })),
            (this.side = new fe({
              context: this.context,
              value: Math.SQRT1_2,
            })),
      ...
      class us extends Ct {
        constructor() {
          super(q(us.getDefaults(), arguments)),
            ...
            (this.mid = new Mt({ context: this.context })),
            (this.side = new Mt({ context: this.context })),
            (this._left = new we({ context: this.context })),
            (this._leftMult = new fe({
              context: this.context,
              value: Math.SQRT1_2,
            })),
            (this._right = new qe({ context: this.context })),
            (this._rightMult = new fe({
              context: this.context,
              value: Math.SQRT1_2,
            })),
            (this._merge = this.output = new zn({ context: this.context })),
      ...
      class hs extends Mn {
        constructor(t) {
          super(t),
            ...
            (this._midSideMerge = new us({ context: this.context })),
            (this._midSideSplit = new cs({ context: this.context })),
      ...
      class ls extends hs {
        constructor() {
          ...
          (this.width = new Rt({
            ...
            (this._midMult = new fe({ context: this.context })),
            this._twoTimesWidthMid.connect(this._midMult.factor),
            this.connectEffectMid(this._midMult),
            (this._oneMinusWidth = new qe({ context: this.context })),
            this._oneMinusWidth.connect(this._twoTimesWidthMid),
            At(this.context.getConstant(1), this._oneMinusWidth),
            this.width.connect(this._oneMinusWidth.subtrahend),
            (this._sideMult = new fe({ context: this.context })),
            this.width.connect(this._twoTimesWidthSide),
            this._twoTimesWidthSide.connect(this._sideMult.factor),
            this.connectEffectSide(this._sideMult);
        }
        static getDefaults() {
          return Object.assign(hs.getDefaults(), { width: 0.5 });
        }
        dispose() {
          return (
            super.dispose(),
      ...
      class ds extends Bn {
        constructor() {
          ...
          (this._lfoL = new Se({
            ...
            (this._amplitudeL = new Mt({ context: this.context })),
            (this._amplitudeR = new Mt({ context: this.context })),
            (this.frequency = new Rt({
              context: this.context,
              value: t.frequency,
              units: "frequency",
        ...
        constructor() {
          super(q(_s.getDefaults(), arguments)),
            ...
            (this.input =
              this.output =
              this._analyser =
                new fs({ context: this.context, size: 256, type: "waveform" }));
        }
        dispose() {
      ...
      class bs extends Ct {
        constructor() {
          ...
          (this.input = this.output = new Mt({ context: this.context })),
      ...
      class ws extends Ct {
        constructor() {
          ...
          (this._solo = this.input =
            new bs({ solo: t.solo, context: this.context })),
        ...
        _getBus(t) {
          return (
            ws.buses.has(t) ||
              ws.buses.set(t, new Mt({ context: this.context })),
            ws.buses.get(t)
          );
        }
        send(t, e = 0) {
          const n = this._getBus(t),
            s = new Mt({ context: this.context, units: "decibels", gain: e });
      ...
      class As extends Ct {
        constructor() {
          ...
          (this._follower = new In({
            ...
            (this.input = new Mt({ context: this.context })),
            (this._gate = this.output = new Mt({ context: this.context })),
      ...
      class Ms extends Ct {
        constructor() {
          ...
          (this._midSideSplit = this.input = new cs({ context: this.context })),
            (this._midSideMerge = this.output =
              new us({ context: this.context })),
            (this.mid = new ks(
