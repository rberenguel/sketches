...
const sketch = (s) => {
  ...
  function flower(scene, x, y, _scale, shift) {
    ...
    if (!cachedRedCloth || cachedRedCloth.length < 5) {
      ...
      textile(cachedRedCloth[l - 1], 0, 0, 600 * cfg.hd, 600 * cfg.hd, 1, 8, [
        r1,
        r2,
        r3,
      ]);
    ...
    if (!cachedBlueCloth) {
      ...
      textile(cachedBlueCloth, 0, 0, 300 * cfg.hd, 300 * cfg.hd, 1, 8, [
        b1,
        b2,
        b3,
      ]);
    ...
    textile(cachedGreenCloth, 0, 0, 100 * cfg.hd, 100 * cfg.hd, 1, 8, [
      ...greens(),
    ]);
  ...
  function stalk(scene, x, y, scale) {
    ...
    textile(cachedGreenCloth, 0, 0, 400 * cfg.hd, scene.height, 1, 8, [
      ...greens(),
    ]);
  ...
  function base(scene, x, y, scale) {
    ...
    textile(cachedGreenCloth, 0, 0, scene.width, scene.height / 2, 1, 8, [
      ...greens(),
    ]);
